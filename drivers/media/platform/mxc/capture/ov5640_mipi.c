...
//	printk("TTTTTTTTTTTTTTTTTTTT %s(mipi):reg=%x,val=%x, ret=%d\n", __func__, reg, val, ret);
			...
			const struct i2c_device_id *id)
{
	...
	printk("################# ov5640_probe Probe Latest called! ############### \n"); 

	/* request power down pin */
	pwn_gpio = of_get_named_gpio(dev->of_node, "pwn-gpios", 0);

	printk("################# ov5640_probe Probe Latest2 called! pwn-gpios %d ############### \n",pwn_gpio);
	...
	printk("################# ov5640_probe Probe Latest3 called! rst_gpio ############### \n");
	printk("################# ov5640_probe Probe Latest4 called! rst_gpio %d ############### \n",rst_gpio);
